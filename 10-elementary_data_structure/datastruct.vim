...
nmap <silent> ,wf :w!
nmap <silent> ,ww :w
nnoremap <w-right> :vertical resize +5
nnoremap <w-up> :resize -5
nnoremap <w-down> :resize +5
nnoremap <w-left> :vertical resize -5
imap ° 0i
imap ¤ $a
vmap [% [%m'gv``
vmap ]% ]%m'gv``
...
exe 'vert 1resize ' . ((&columns * 20 + 84) / 169)
exe '2resize ' . ((&lines * 39 + 23) / 46)
exe 'vert 2resize ' . ((&columns * 20 + 84) / 169)
exe 'vert 3resize ' . ((&columns * 117 + 84) / 169)
exe 'vert 4resize ' . ((&columns * 30 + 84) / 169)
argglobal
enew
file \[Buf\ List]
